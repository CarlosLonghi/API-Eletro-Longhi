...
public interface AccessoryApi {
    @Operation(
            ...
            description = "Cria um novo acessório (ex: cabo, controle, etc.). Requer perfil ADMIN ou GERENTE."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "Remove um acessório do sistema pelo seu ID. É um soft delete (o registro deixa de aparecer nas consultas, mas é preservado). Requer perfil ADMIN ou GERENTE."
    )
    @ApiResponses({
